      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-90 mb-6">
              차살때 앱 출시!
            </h2>
            <p className="text-lg md:text-xl text-gray-60 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#"
                className="inline-flex items-center gap-3 px-6 py-3 bg-black text-white rounded-button hover:bg-gray-90 transition-all duration-300"
              >
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-90 mb-1">간편한 견적</h4>
                  <p className="text-sm text-gray-60">빠른 견적 확인</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-90 mb-1">실시간 알림</h4>
                  <p className="text-sm text-gray-60">견적 및 출고 알림</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-90 mb-1">안전한 관리</h4>
                  <p className="text-sm text-gray-60">견적 내역 저장</p>
                </div>
              </div>
            </div>
          </div>
