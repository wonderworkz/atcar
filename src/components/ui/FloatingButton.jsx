...
const FloatingButton = ({ onConsultClick }) => {
  ...
  return (
    <>
      {/* PC 버전 */}
      <div className="hidden md:block fixed bottom-[20px] left-1/2 -translate-x-1/2 w-full max-w-[calc(100%-80px)] z-50">
        <div
          className="overflow-hidden rounded-[40px] border border-white/50 bg-[rgba(249,250,255,0.60)] px-[40px] py-[36px] backdrop-blur-[50px]"
          style={{
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col items-start gap-[10.5px]">
              <div className="flex items-center justify-center gap-2">
                <p className="text-[26px] font-bold tracking-tighter text-gray-900">
                  쉽고 빠른 견적 문의
                </p>
              </div>
              <div className="flex items-center justify-center gap-1">
                ...
                <a href={`tel:${phoneNumber.replace(/-/g, '')}`}>
                  <p className="text-xl font-medium tracking-tighter text-gray-600">
            ...
            {/* 우측: 버튼 2개 */}
            <div className="flex items-center justify-between gap-6 w-full max-w-[482px]">
              ...
              <div className="flex min-w-0 flex-1 basis-0">
                <button
                  ...
                  className="flex h-[52px] w-full items-center justify-center rounded-full bg-[#3B82F6] text-sm font-bold tracking-tighter text-white active:bg-[#2563EB]"
                >
                  무료 견적 받아보기
                </button>
              </div>
